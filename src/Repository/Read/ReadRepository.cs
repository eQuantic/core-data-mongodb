...
namespace eQuantic.Core.Data.MongoDb.Repository.Read
{
        ...
        where TEntity : class, IEntity, new()
    {
        ...
        public IEnumerable<TEntity> AllMatching(ISpecification<TEntity> specification, params ISorting[] sortColumns)
        {
            return GetSet().OrderBy(sortColumns).Where(specification.SatisfiedBy());
        }
